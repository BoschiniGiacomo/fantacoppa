...
export default function MatchDetailScreen({ navigation, route }) {
  ...
  const knockoutLayout = useMemo(
    () => ({
      ...
      stageColumnTitle: styles.knockoutStageColumnTitle,
      semiLabelRow: styles.knockoutSemiLabelRow,
      twoLegScoreCols: styles.knockoutTwoLegScoreCols,
      finalHeaderCol: styles.knockoutFinalHeaderCol,
      finalColStack: styles.knockoutFinalColStack,
      finalColBody: styles.knockoutFinalColBody,
      finalMatchWrap: styles.knockoutFinalMatchWrap,
      ...
      flowColStraightStack: styles.knockoutFlowColStraightStack,
      flowColStraightStackTall: styles.knockoutFlowColStraightStackTall,
      flowStraightHeaderSpacer: styles.knockoutFlowStraightHeaderSpacer,
...
const styles = StyleSheet.create({
  ...
  knockoutStageColumnTitle: { fontSize: 12, fontWeight: '800', color: '#6b7280', textTransform: 'uppercase', marginBottom: 4, alignSelf: 'flex-start' },
  knockoutFinalHeaderCol: { flex: 1.08, alignSelf: 'flex-start', marginLeft: -2 },
  knockoutFinalColStack: { justifyContent: 'flex-start', paddingTop: 0, alignSelf: 'stretch' },
  knockoutFinalColBody: { paddingTop: 0, justifyContent: 'flex-start' },
  knockoutFinalMatchWrap: { flex: 1, justifyContent: 'center', paddingTop: 20, width: '100%' },
  ...
  knockoutFlowColStraightStack: {
    width: 56,
    alignSelf: 'flex-start',
    gap: 10,
  },
  knockoutFlowColStraightStackTall: {},
  knockoutFlowStraightHeaderSpacer: { height: 22 },
  knockoutFlowStraightTieSlot: {
    minHeight: 76,
    justifyContent: 'center',
    alignItems: 'center',
  },
  ...
  knockoutFlowStraightLineTall: { width: 32 },
  knockoutFlowStraightLineCompact: { width: 18 },
