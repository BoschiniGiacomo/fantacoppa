...
const styles = StyleSheet.create({
  ...
  playerPhotoPickerBtn: { width: 80, height: 80, overflow: 'hidden', backgroundColor: '#f0f2f5', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#e2e8f0', borderStyle: 'dashed', borderRadius: 10 },
  playerPhotoPreview: { width: 80, height: 80 },
